...
const Widget = () => {
    ...
    return (
        <Grid container spacing={3} justifyContent="left" style={{ padding: '20px' }}>
            ...
            >
                <Card style={{ width: '100%', textAlign: 'center', padding: '20px', minHeight: '210px' }}>
                    <img
                        src="https://www.greenworldholidays.com/wp-content/uploads/2019/12/google-verified-reviews.jpg"
                        alt="Placeholder"
                        style={{ width: '220px', height: '110px', margin: 'auto' }}
                    ...
                    <Button
                        ...
                        onClick={() =>
                            window.open(
                                'https://www.google.com/maps/place/loansHub+-+Your+local+home+loan+experts+online/@-24.7593997,114.3099059,4z/data=!4m8!3m7!1s0x6b91592c752fc429:0x8494743c28332fa5!8m2!3d-26.4420923!4d136.013279!9m1!1b1!16s%2Fg%2F11gzqbnppv?entry=ttu',
                                '_blank'
                            )
                        }
                    >
